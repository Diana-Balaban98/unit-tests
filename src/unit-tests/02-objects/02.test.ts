...
beforeEach(() => {
    city = {
        ...
        governmentBuildings: [
            {type: 'HOSPIATAL', budget: 200000, staffCount: 200, address: {street: {title: 'Central Str'}}},
...
// 1. Дополнить тип GovernmentBuildingType
// 2. Заполнить объект city, чтобы тесты ниже прошли

test("test city should contains hospital and fire station", () => {
    expect(city.governmentBuildings.length).toBe(2)

    expect(city.governmentBuildings[0].type).toBe('HOSPIATAL');
